<?php
	...
	function ticketmachine_calendar_ajax_events($options){

		$params = [ 
			"query" => sanitize_text_field($options['q']), 
			"sort" =>  sanitize_text_field($options['sort']), 
			"tag" =>  sanitize_text_field($options['tag']), 
			"approved" => 1 
		];
