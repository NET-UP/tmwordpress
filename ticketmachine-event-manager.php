<?php
	...
	*/
	...
	//get page slugs
	$post = get_post($tm_globals->events_slug_id); 
	$tm_globals->events_slug = $post->post_name;
	$post = get_post($tm_globals->event_slug_id); 
	$tm_globals->event_slug = $post->post_name;
