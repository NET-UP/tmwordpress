    ...
    <div class="row">
        <div class="col-xl-9">
            ...
            <h1 class="wp-heading-inline mr-3 mb-3">
                ...
                <a target="_blank" href="/<?php echo esc_html($globals->events_slug); ?>" class="button button-secondary ml-2"><?php esc_html_e("Go to live webpage", "ticketmachine-event-manager"); ?></a>
            </h1>
