            ...
            <div id="post-body" class="metabox-holder columns-2">
                    ...
                    <div id="side-sortables" class="meta-box-sortables ui-sortable">
                                    ...
                                    <div id="minor-publishing">
                                        <div id="misc-publishing-actions">
                                            <div class="misc-pub-section misc-pub-post-status">
                                                <span><?php echo __('Status', 'ticketmachine') ?>: </span>
                                                <select style="float: right; margin-top: -2px;" name="approved">
                                                    <option value="1" <?php if($event->approved == 1){ echo "selected"; } ?>><?php echo __('Published', 'ticketmachine') ?></option>
                                                    <option value="0" <?php if($event->approved != 1){ echo "selected"; } ?>><?php echo __('Draft', 'ticketmachine') ?></option>
                                                </select>
                                            </div>
                                            <div class="misc-pub-section misc-pub-section misc-pub-visibility">
                                                <label for="event_edit_locationname"><?php echo __('Hint Text','ticketmachine'); ?></label>
                        ...
                        <div id="postimagediv" class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <input id="upload_image_button" type="button" class="button" style="display:block;width:100%;" value="<?php echo __( 'Add Image', 'ticketmachine' ); ?>" />
                                ...
                                <div class="tagsdiv" id="post_tag">
                                    <div class="jaxtag">
                                        <div class="ajaxtag hide-if-no-js">
                                            <label class="screen-reader-text" for="new-tag-post_tag"><?php echo __('Create new tag', 'ticketmachine') ?></label>
                ...
                <div id="postbox-container-2" class="postbox-container">
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside inside-pad">
                            <div>
                                <label><?php echo __('Entry Time', 'ticketmachine') ?></label>
                            </div>
                            <div class="row">
                                <div class="input-group col-8">
                                    <input type="text" name="entrytime[date]" class="form-control date entrytime" value="<?php echo date_i18n(ISO8601, strtotime($event->entrytime)); ?>">
                                </div>
                                <div class="input-group col-4">
                                    <input type="text" name="entrytime[time]" class="form-control time" value="<?php echo date_i18n(ISO8601, strtotime($event->entrytime)); ?>">
                                </div>
                            </div>
                            <div>
                                <label><?php echo __('Event begins at', 'ticketmachine') ?></label>
                            </div>
                            <div class="row">
                                <div class="input-group col-8">
                                    <input type="text" name="ev_date[date]" class="form-control date starttime" value="<?php echo date_i18n(ISO8601, strtotime($event->ev_date)); ?>">
                                </div>
                                <div class="input-group col-4">
                                    <input type="text" name="ev_date[time]" class="form-control time" value="<?php echo date_i18n(ISO8601, strtotime($event->ev_date)); ?>">
                                </div>
                            </div>
                            <div>
                                <label><?php echo __('Event ends at', 'ticketmachine') ?></label>
                            </div>
                            <div class="row">
                                <div class="input-group col-8">
                                    <input type="text" name="endtime[date]" class="form-control date endtime" value="<?php echo date_i18n(ISO8601, strtotime($event->endtime)); ?>">
                                </div>
                                <div class="input-group col-4">
                                    <input type="text" name="endtime[time]" class="form-control time" value="<?php echo date_i18n(ISO8601, strtotime($event->endtime)); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
