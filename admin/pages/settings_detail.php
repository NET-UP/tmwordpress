<table class="form-table">
	<tbody>
        ...
        <tr>
            <th class="ml-4"><label><?php echo __('iCal', 'ticketmachine'); ?></label></th>
            <td><input name="show_ical" type="checkbox" value=1 class="regular-text"></td>
        </tr>
        <tr>
            <th class="ml-4"><label><?php echo __('Google Kalender', 'ticketmachine'); ?></label></th>
            <td><input name="show_google_calendar" type="checkbox" value=1 class="regular-text"></td>
        </tr>
        <tr>
            <th class="ml-4"><label><?php echo __('Facebook', 'ticketmachine'); ?></label></th>
            <td><input name="show_facebook" type="checkbox" value=1 class="regular-text"></td>
        </tr>
        <tr>
            <th class="ml-4"><label><?php echo __('Twitter', 'ticketmachine'); ?></label></th>
            <td><input name="show_twitter" type="checkbox" value=1 class="regular-text"></td>
        </tr>
        <tr>
            <th class="ml-4"><label><?php echo __('E-Mail', 'ticketmachine'); ?></label></th>
            <td><input name="show_email" type="checkbox" value=1 class="regular-text"></td>
        </tr>
        <tr>
            <th class="ml-4"><label><?php echo __('Messenger', 'ticketmachine'); ?></label></th>
            <td><input name="show_messenger" type="checkbox" value=1 class="regular-text"></td>
        </tr>
        <tr>
            <th class="ml-4"><label><?php echo __('WhatsApp', 'ticketmachine'); ?></label></th>
