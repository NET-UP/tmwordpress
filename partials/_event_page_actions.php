<?php 
    ...
    function ticketmachine_event_page_actions ( $event, $globals ) {
        ...
        wp_add_inline_script( "fileSaver_JS", "jQuery('.download-ics').click(function(){var cal = ics();cal.addEvent('" . $event->ev_name . "', '" . $url . "', '" . $event->ev_location_name . "', '" . ticketmachine_i18n_date(DATE_ISO8601, $event->ev_date) . "', '" . ticketmachine_i18n_date(DATE_ISO8601, $event->endtime) . "');cal.download();});");
