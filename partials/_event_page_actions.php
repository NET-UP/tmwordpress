...
#<% end %>
        ...
        $tm_output .= '
                <div class="title-height tm_actions text-right no-mobile-height mb-3 mb-md-0">
                    ...
                    <a class="btn btn-secondary d-inline-block d-sm-none mb-1 mb-md-0" href="fb-messenger://share/?link='. $url .'">
