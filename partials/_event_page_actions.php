<?php 
    ...
    function ticketmachine_event_page_actions ( $event, $globals ) {
        ...
        wp_add_inline_script( "fileSaver_JS", "jQuery('.download-ics').click(function(){var cal = ics();cal.addEvent('" . $event->ev_name . "', '" . $url . "', '" . $event->ev_location_name . "', '" . ticketmachine_i18n_date("Ymd", $event->ev_date) .'T'. ticketmachine_i18n_date("His", $event->ev_date) . "', '" . ticketmachine_i18n_date("Ymd", $event->ev_date) .'T'. ticketmachine_i18n_date("His", $event->endtime) . "');cal.download();});");
