<?php 
    ...
    function ticketmachine_event_page_actions ( $event, $globals ) {
        ...
        $event->ical = '"Demo Event", "This is an all day event", "Nome, AK", "8/7/2013", "8/7/2013"';
        ...
        $ticketmachine_output = '
                <div class="title-height ticketmachine_actions text-right no-height-mobile mb-3 mb-lg-0">
                    ...
                    if ($globals->show_social_media_ical && $globals->show_social_media) {
                        $ticketmachine_output .= '<a class="btn btn-secondary mb-1 mb-lg-0 ml-1" href="javascript: ics().addEvent(' . $event->ical . ').download()" title="' . esc_attr('Save as iCal', 'ticketmachine') . '">
