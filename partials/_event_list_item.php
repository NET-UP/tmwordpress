				...
				$ticketmachine_output .= '<div class="card-body position-relative">';
				  ...
				  $ticketmachine_output .= '<div class="row pt-2">';
					...
					$ticketmachine_output .= '<div class="col-sm-4 col-md-5">';
					  $ticketmachine_output .= '<a aria-label="' . esc_attr("To ticket selection for", 'ticketmachine-event-manager') . ' ' . esc_html($event->ev_name)  . '" href="/' . esc_html($globals->event_slug) .'/?id=' . esc_html($event->id) . '" class="btn btn-primary btn-sm px-3 float-sm-right d-block" title="' . esc_html__("To ticket selection", 'ticketmachine-event-manager') . '">';
