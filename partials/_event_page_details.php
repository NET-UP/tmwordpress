        ...
        $tm_output = '<div class="card mb-3">
                            <div class="row card-body position-relative">
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-2">
                                        <i class="far fa-calendar-alt tm-icon" aria-hidden="true"></i> &nbsp;'. date_i18n( "d. F", strtotime(get_date_from_gmt($event->ev_date)) ) .' 
                                        &nbsp; <i class="far fa-clock tm-icon" aria-hidden="true"></i> &nbsp;'. date_i18n( "H:i", strtotime(get_date_from_gmt($event->ev_date)) ) .'
                                    </div>
                                    <label>'. __("End", "ticketmachine").':</label>
                                    <div class="mb-2">
                                        <i class="far fa-calendar-alt tm-icon" aria-hidden="true"></i> &nbsp;'. date_i18n( "d. F", strtotime(get_date_from_gmt($event->endtime)) ) .' 
                                        &nbsp; <i class="far fa-clock tm-icon" aria-hidden="true"></i> &nbsp;'. date_i18n( "H:i", strtotime(get_date_from_gmt($event->endtime)) ) .'
                                    </div> 
